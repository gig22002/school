...
class final_topo(Topo):
  def build(self):
    ...
    #Connect hosts to respective switches, 0 to 0 for all
    self.addLink(h1,s1, port1=0, port2=0)
    self.addLink(h2,s2, port1=0, port2=0)
    self.addLink(h3,s2, port1=0, port2=0)
    self.addLink(h4,s4, port1=0, port2=0) #untrusted host
    self.addLink(h5,s5, port1=0, port2=0) #server
    
    #Connect s1,s2,s3,s5 to s4 respectively
