...
In order to center the images, I used [this tool](https://www.batchpngtools.com/center-png). Be sure that the image size is the SAME FOR ALL IMAGES! I used 1024x1024.
